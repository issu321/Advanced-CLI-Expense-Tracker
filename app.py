...
def export_txt(user_id, username):
    ...
    lines.append("")
    lines.append("Developed by issu321 | github.com/issu321")
    return "\n".join(lines)
...
def page_login():
    ...
    st.markdown(f'<p style="text-align:center;color:#666;font-size:0.8rem;">Developed by issu321 | github.com/issu321</p>', unsafe_allow_html=True)
...
def render_sidebar():
    with st.sidebar:
        ...
        st.markdown("<br>", unsafe_allow_html=True)
        st.markdown(f'<div style="text-align:center;color:#444;font-size:0.7rem;">Developed by issu321</div>', unsafe_allow_html=True)
